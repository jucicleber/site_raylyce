      ...
      <div className="row">
        ...
        <div className="col-4 justify-content-end align-items-right p-3">
          ...
          <div className="offset-10 d-flex justify-content-center align-items-right " >
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-cart" viewBox="0 0 20 20" onClick={() => appView.clickCarrinho(appView.novoItem)}>
